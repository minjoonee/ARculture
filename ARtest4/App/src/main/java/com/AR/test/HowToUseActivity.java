...
import com.AR.test.fragment.DotPageChange;
import com.AR.test.fragment.HowToUseAdapter;
...
public class HowToUseActivity extends AppCompatActivity {
    ...
    private void initViewPager() {
        ...
        HowToUseAdapter pagerAdapter = new HowToUseAdapter(getSupportFragmentManager());
        viewPager.addOnPageChangeListener(new DotPageChange(dots, nextPageButton, skipButton, doneButton));
    ...
    public void done() {
        Intent i = new Intent(HowToUseActivity.this, MainActivity.class);
        startActivity(i);
    }
}
